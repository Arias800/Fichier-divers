...
def showMovies(sSearch=''):
    ...
    if (aResult[0] == True):
        ...
        for aEntry in aResult[1]:
            ...
            if '/serie' in sUrl:
                oGui.addNewDir('tvshows', SITE_IDENTIFIER, 'showSxE', sDisplayTitle, '', sThumb, sDesc, oOutputParameterHandler)
            else:
                oGui.addNewDir('movies', SITE_IDENTIFIER, 'showLink', sDisplayTitle, '', sThumb, sDesc, oOutputParameterHandler)
