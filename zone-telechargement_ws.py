...
def DecryptDlProtecte(url):
    ...
    oRequestHandler.addMultipartFiled(headersMulti)
    oRequestHandler.addHeaderEntry('Referer',url)
    oRequestHandler.addHeaderEntry('Accept','text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8')
    oRequestHandler.addHeaderEntry('User-Agent','Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:64.0) Gecko/20100101 Firefox/64.0')
    oRequestHandler.addHeaderEntry('Accept-Language','fr,fr-FR;q=0.8,en-US;q=0.5,en;q=0.3')
    oRequestHandler.addHeaderEntry('Accept-Encoding','gzip, deflate')
    oRequestHandler.addHeaderEntry('Alt-Used','www.dl-protect1.com:443')
    oRequestHandler.addHeaderEntry('Cookie',Cook)
    oRequestHandler.addParametersMultipart(data)
    ...
    #Requete
    sHtmlContent = oRequestHandler.request()
    sHtmlContent = zlib.decompress(sHtmlContent, 16+zlib.MAX_WBITS)
    fh = open('d:\\test.txt', "w")
...
def encode_multipart(fields, files, boundary = None):
    ...
    headers = {
        'Content-Type': 'multipart/form-data; boundary=---------------------------1{0}'.format(boundary),
