...
from resources.hosters.upvid import sPattern1
...
def showGenres():
    ...
    liste.append(['Noêl', URL_MAIN + 'genre/noel/' + sUrl])
...
def showNetwork():
    ...
    oGui.addNetwork(SITE_IDENTIFIER, SERIE_AMAZON[1], 'S�ries (Amazon Prime)', 'host.png', oOutputParameterHandler)
