...
class cRequestHandler:
    ...
    def addParametersMultipart(self, mParameterValue):
        self.__aParametersMultipart = mParameterValue
        VSlog(self.__aParametersMultipart)
    ...
    def __callRequest(self):
        ...
        elif self.__aParametersMultipart:
            sParameters = self.__aParametersMultipart
        else:
