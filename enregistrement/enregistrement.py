...
class cEnregistremement:
    ...
    def programmation_enregistrement(self, sUrl):
        ...
        heureFichier = oGui.showKeyBoard(None,"Heure du debut d\'enregistrement au format Date-Heure-Minute")
        heureFin = oGui.showKeyBoard(None,"Heure du fin d\'enregistrement au format Heure-Minute")
